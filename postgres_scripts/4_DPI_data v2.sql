...
drop table if exists metadata.DPI_id_level;
with DPI_agg as (
...
select * 
into metadata.DPI_id_level
from DPI_scores
;
--select * from metadata.DPI_id_level
